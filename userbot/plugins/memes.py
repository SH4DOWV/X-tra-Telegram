...
RUNSREACTS = [
    "Vorrei suicidarmi, ma se mi ammazzo, io non potrei vederti più😣",
    "Vorrei stare con te per sempre💕",
    "Amami, perchè sono Shadow",
    "Ti ho sempre voluto bene",
    "Vorrei abbracciarti per sempre💞.",
    "Ti amo❤️",
    "Voglio solo riempirti di coccole🦊.",
    "Amami!",
...
@register(outgoing=True, pattern="^.lov$")
@errors_handler
...
@register(outgoing=True, pattern="^.disable lov$")
@errors_handler
...
@register(outgoing=True, pattern="^.enable lov$")
@errors_handler
...
async def claptext(memereview):
    ...
    if not memereview.text[0].isalpha() and memereview.text[0] not in (
        ...
        if message:
            ...
            await memereview.edit("`Haha, Io non batto le mani inutilmente!`")
            return
        reply_text = "👏 "
