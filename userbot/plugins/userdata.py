...
# ====================== CONSTANT ===============================
INVALID_MEDIA = "**Formato del file non valido.**"
PP_CHANGED = "**📷Foto Profilo cambiata con successo.**"
PP_TOO_SMOL = "**Immagine troppo piccola, usane una più grande.**"
PP_ERROR = "**Errore nel caricare l'immagine.**"

BIO_SUCCESS = "**📝Bio cambiata.**"

NAME_OK = "```📰Nome cambiato.```"
USERNAME_SUCCESS = "**✏️Username cambiato.**"
USERNAME_TAKEN = "**Questo Username è stato già preso.**"
